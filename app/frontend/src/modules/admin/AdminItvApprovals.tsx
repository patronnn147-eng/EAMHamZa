  ...
  return (
    <div className="p-8 animate-premium-fade-in bg-transparent">
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-2">Approbations ITV</h1>
          <p className="text-gray-500 font-medium border-l-4 border-violet-500 pl-4 py-1">
          ...
          <Table>
            <TableHeader className="bg-gray-50/50">
              <TableRow className="border-b border-gray-100">
                <TableHead className="font-black py-6 px-6 text-gray-400 uppercase tracking-widest text-[10px]">Demandeur</TableHead>
                <TableHead className="font-black text-gray-400 uppercase tracking-widest text-[10px]">Machine</TableHead>
                <TableHead className="font-black text-gray-400 uppercase tracking-widest text-[10px]">Priorité</TableHead>
                <TableHead className="font-black text-gray-400 uppercase tracking-widest text-[10px]">Description</TableHead>
                <TableHead className="font-black text-gray-400 uppercase tracking-widest text-[10px]">Date</TableHead>
                <TableHead className="font-black text-gray-400 uppercase tracking-widest text-[10px] text-right">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-20 text-gray-400 italic font-medium">Récupération des demandes...</TableCell>
                </TableRow>
              ) : filteredRequests.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-20 text-gray-400 font-bold tracking-tight">Aucune demande en attente</TableCell>
                </TableRow>
              ) : filteredRequests.map((req) => (
                <TableRow key={req.id} className="hover:bg-white/50 transition-all group flex-wrap">
                  <TableCell className="py-6 px-6">
                    <div className="font-black text-gray-900">{req.requested_by_nom}</div>
                    <div className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Chef Opérateur</div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="max-w-sm">
                    <div className="text-sm font-medium text-gray-600 leading-relaxed italic border-l-2 border-gray-100 pl-3">
                      "{req.description}"
                    </div>
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center text-gray-400 font-bold text-xs gap-1.5">
        ...
        <DialogContent className="sm:max-w-[425px] rounded-[2rem] glass-card border-none p-0 overflow-hidden shadow-2xl">
          ...
          <div className="p-8 space-y-6 bg-white/80">
            <div className="space-y-3">
              <Label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Motif de rejet</Label>
              <div className="relative">
                ...
                <Textarea 
                  ...
                  className="min-h-[120px] bg-gray-50/50 border-gray-100 rounded-2xl pl-11 py-4 font-medium leading-relaxed focus:ring-violet-500/20 focus:border-violet-500/30 transition-all"
                />
              </div>
            </div>
