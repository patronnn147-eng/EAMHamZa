...
export default function AdminWorkOrdersTable() {
    ...
    return (
        <div className="space-y-6 p-6 pb-20">
            ...
            <Card className="border-none shadow-xl bg-slate-800/80 backdrop-blur-md border border-blue-800/30 overflow-hidden">
                <CardHeader className="border-b border-blue-800/30 bg-slate-900/50 pb-4">
                ...
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader className="bg-slate-900/80 border-b border-blue-800/30">
                                <TableRow>
                            ...
                            <TableBody>
                                {filtered.map((wo) => {
                                    ...
                                    return (
                                        <TableRow key={wo.id} className="hover:bg-blue-900/20 border-b border-blue-800/20 transition-colors group">
                                            ...
                                            <TableCell className="text-right">
                                                <Button
                                                    ...
                                                    className="border-blue-700/50 hover:bg-blue-800/40 text-blue-100 hover:text-white shadow-sm bg-slate-800/50"
                                                >
