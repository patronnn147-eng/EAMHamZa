      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 font-medium">Monitoring global des opérations et performances (Administrateur)</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="shadow-sm border-l-4 border-l-blue-500">
            <CardContent className="pt-6">
              <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">OTs Complétés Syst.</p>
              <h3 className="text-4xl font-black text-gray-900">{data.kpis.total_completed}</h3>
          ...
          <Card className="shadow-sm border-l-4 border-l-indigo-500">
            <CardContent className="pt-6">
              <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Durée Moyenne Syst.</p>
              <h3 className="text-4xl font-black text-gray-900">{formatDuration(data.kpis.avg_duration_minutes)}</h3>
          ...
          <Card className="shadow-sm border-l-4 border-l-emerald-500">
            <CardContent className="pt-6">
              <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Requêtes Validées</p>
              <h3 className="text-4xl font-black text-gray-900">{data.kpis.requests_validated}</h3>
          ...
          <Card className="shadow-sm border-l-4 border-l-rose-500">
            <CardContent className="pt-6">
              <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Requêtes Rejetées</p>
              <h3 className="text-4xl font-black text-gray-900">{data.request_trends.total_rejected}</h3>
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="p-6 h-[320px]">
              {data.request_trends.daily_trends.length === 0 ? (
                <div className="h-full flex items-center justify-center text-gray-400">Aucune donnée de tendance</div>
              ) : (
        ...
        <Card className="shadow-sm mb-8">
          ...
          <CardContent className="p-6 h-[350px]">
            {data.technician_performance.length === 0 ? (
              <div className="h-full flex items-center justify-center text-gray-400">Aucune donnée technicien</div>
            ) : (
              <ResponsiveContainer width="100%" height="100%">
