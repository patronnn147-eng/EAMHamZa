...
export default function PlanningDetailPage() {
  ...
  const getStatusIcon = (dateDebut: string, dateFin: string) => {
    ...
    if (now < start) {
      return <Clock className="h-5 w-5 text-blue-400" title="Upcoming" />;
    } else if (now >= start && now <= end) {
      return <CheckCircle className="h-5 w-5 text-green-600" title="Active" />;
    } else {
      return <XCircle className="h-5 w-5 text-blue-400" title="Completed" />;
    }
  };
  ...
  const getRoleColor = (role: string) => {
    ...
    return roleColors[role as keyof typeof roleColors] || 'bg-gray-100 text-blue-50';
  };
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-white mb-2">Planning Not Found</h3>
          <p className="text-blue-300">The planning you're looking for doesn't exist or has been removed.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-bold text-white">{planning.identifiant_planning}</h1>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {planning.shift_type && (
                    <span className="text-blue-300">({planning.shift_type.toLowerCase()})</span>
                  )}
                </div>
              </div>
              ...
              {planning.assigned_users.length === 0 ? (
                ...
                <div className="space-y-4">
                  {planning.assigned_users.map((user) => (
                    <div key={user.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-slate-800/50">
                      <div className="flex items-center gap-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-blue-300">Work Zone:</span>
