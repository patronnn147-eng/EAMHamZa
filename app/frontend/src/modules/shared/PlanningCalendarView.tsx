        ...
        return (
            <div className="space-y-6">
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-blue-300">The planning you're looking for doesn't exist.</p>
                </div>
            </div>
        );
    }
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-1">
                                <label className="text-xs font-medium text-blue-300 uppercase">Work Zone</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-medium text-blue-300 uppercase">Type</label>
                                <div className="flex items-center gap-2">
