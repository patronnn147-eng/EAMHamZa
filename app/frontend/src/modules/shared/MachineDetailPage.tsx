    ...
    if (!machine) {
        return (
            <div className="text-center py-16">
                <p className="text-gray-500 text-lg">Machine non trouvée</p>
                        ...
                        <TabsContent value="overview" className="mt-4 space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    { label: 'OT Ouverts', value: openWorkOrdersCount, color: openWorkOrdersCount > 0 ? 'text-red-600' : 'text-gray-600' },
                                    ...
                                    {interventions.length === 0 ? (
                                        ...
                                        <div className="space-y-3">
                                            {interventions.map((intervention) => (
                                                <div key={intervention.id} className="p-4 border border-gray-100 rounded-xl hover:border-blue-200 hover:bg-blue-50/30 transition-colors">
                                                    <div className="flex items-start justify-between mb-2">
                                                        <div className="flex items-center gap-2">
                                                            <FileText className="h-4 w-4 text-blue-600 shrink-0" />
                                                            <p className="font-semibold text-sm text-gray-800">Intervention #{intervention.id}</p>
                                                        </div>
