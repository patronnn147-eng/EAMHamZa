...
export default function Archives() {
  ...
  const getTypeBadge = (type: string) => {
    const typeConfig = {
      ...
      AUTRE: { label: 'Other', className: 'bg-gray-100 text-blue-50' },
    };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-4xl font-bold text-white">Archives</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredArchives.length === 0 ? (
          <div className="col-span-full text-center py-12">
            <p className="text-blue-300">No archives found</p>
          </div>
        ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-blue-300 mt-1">{archive.identifiant_archive}</p>
                    </div>
                  </div>
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-blue-300">Archived:</span>
                  ...
                  {archive.ordre_travail_id && (
                    <div className="flex justify-between">
                      <span className="text-blue-300">Work Order:</span>
