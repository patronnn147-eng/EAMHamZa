            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                        <p className="font-semibold text-sm text-gray-800">{machine.nom}</p>
                ...
                {/* URL display */}
                <div
                    className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-colors"
                    onClick={handleCopy}
                    title="Copier le lien"
                >
                    <span className="text-xs text-gray-500 truncate flex-1 font-mono">{machineUrl}</span>
                    {copied
