      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-blue-300">{formData.rapport.length} characters</p>
          </div>
          ...
          <div className="border-t pt-4 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <p className="text-xs text-blue-400">Quel type de panne avez-vous constaté ?</p>
              </div>
              <div className="grid gap-2">
                ...
                <p className="text-xs text-blue-400">La prédiction du modèle correspondait-elle à la réalité ?</p>
              </div>
            </div>
          </div>
        </div>
        <DialogFooter>
          ...
          <Button onClick={onSubmit} className="bg-blue-600 hover:bg-blue-700 text-white">{editingIntervention ? 'Update' : 'Record'}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
