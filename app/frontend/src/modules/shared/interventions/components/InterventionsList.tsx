    ...
    return (
      <Card>
        <CardContent className="text-center py-12">
          <p className="text-blue-300">No interventions found</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="grid grid-cols-1 gap-4">
      {interventions.map((intervention) => (
        <Card key={intervention.id} className="hover:shadow-md transition-shadow">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-300 mt-1">{getWorkOrderInfo(intervention.ordre_travail_id)}</p>
              </div>
          ...
          <CardContent>
            <div className="mb-4">
              <h4 className="text-sm font-medium text-blue-100 mb-2">Report:</h4>
              <p className="text-sm text-blue-200 whitespace-pre-wrap bg-slate-800/50 p-3 rounded-md">
