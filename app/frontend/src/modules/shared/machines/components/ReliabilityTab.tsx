    ...
    return (
        <div className="flex flex-col items-center justify-center py-4">
            ...
            <div className="-mt-20 mb-16 text-center">
                <span className="text-2xl font-black text-blue-50">{value.toFixed(1)}%</span>
                <p className="text-xs text-blue-400 mt-0.5">Disponibilité</p>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="space-y-3">
            {events.map((event) => (
                <div
                    key={event.id}
                    className="flex items-start gap-4 p-3 rounded-lg border border-blue-800/50 hover:border-red-200 hover:bg-red-50/30 transition-colors"
                >
                    {/* Duration pill */}
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                            <p className="font-semibold text-sm text-blue-50">Intervention #{event.id}</p>
                        ...
                        {event.rapport && (
                            <p className="text-xs text-blue-200 mt-1.5 line-clamp-2 leading-relaxed">
                                {event.rapport}
                            </p>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="text-right">
                                <span className="text-3xl font-black text-white">{reliabilityScore}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="md:col-span-1 flex flex-col items-center justify-center">
                    <CardHeader className="pb-0 text-center w-full">
                        <CardTitle className="text-sm text-blue-200">Taux de disponibilité</CardTitle>
                    </CardHeader>
