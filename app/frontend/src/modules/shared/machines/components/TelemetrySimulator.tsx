            ...
            <DialogContent className="max-w-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-4">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-2">
                            <Label className="text-xs uppercase text-gray-500 mb-2 block">Scénarios Prédéfinis</Label>
                            <div className="grid grid-cols-2 gap-2">
                                {PRESETS.map((preset) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-[10px] text-gray-500 line-clamp-1">{preset.description}</div>
                                    </Button>
                                ))}
                            </div>
                        </div>
