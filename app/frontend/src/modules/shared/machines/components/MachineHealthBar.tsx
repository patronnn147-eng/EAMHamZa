...
const MachineHealthBar: React.FC<MachineHealthBarProps> = ({ health, compact = false }) => {
        ...
        return (
            <div className="space-y-1">
                <div className="flex items-center justify-between">
                    <span className="text-xs text-blue-300 font-medium">Santé Machine</span>
    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-blue-100">Score de Santé</span>
                <span className={`text-2xl font-black ${textColor}`}>{score}<span className="text-sm font-normal text-blue-400">/100</span></span>
            </div>
