...
function StatCard({
    label, value, sublabel, icon: Icon, color = 'text-gray-800',
}: {
    label: string;
    value: string;
    sublabel?: string;
    ...
    return (
        <div className="space-y-6">
                ...
                <Card>
                    <CardContent className="pt-5">
                        <div className="flex items-center justify-between mb-4">
                            <p className="font-semibold text-gray-800">Vue d'ensemble flotte</p>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-gray-600">Fiables (Excellent + Bon)</span>
                                </div>
                                ...
                                <div className="space-y-2">
                                    {sortedEntries
                                        ...
                                        .map((e) => (
                                            <div
                                                key={e.machineId}
                                                className="flex items-center justify-between p-2 rounded-lg bg-white border border-red-100 cursor-pointer hover:border-red-300 transition-colors"
                                                onClick={() => navigate(`/machines/${e.machineId}`)}
                                            >
                                                <div>
                                                    <p className="text-sm font-semibold text-gray-800">{e.machineName}</p>
            ...
            <Card>
                ...
                <CardContent>
                    {entries.length === 0 ? (
                        <p className="text-center text-gray-400 py-8">Aucune machine trouvée</p>
                    ) : (
                        <div className="space-y-2">
                            {sortedEntries.map((entry) => {
                                ...
                                return (
                                    <div
                                        key={entry.machineId}
                                        className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 cursor-pointer border border-transparent hover:border-gray-200 transition-colors"
                                    ...
                                    >
                                        ...
                                        <div className="min-w-[160px] max-w-[200px]">
                                            <p className="font-semibold text-sm text-gray-800 truncate">{entry.machineName}</p>
                                        </div>
                                        ...
                                        {/* Uptime */}
                                        <span className="text-xs text-gray-500 w-16 text-right shrink-0 hidden md:inline">
