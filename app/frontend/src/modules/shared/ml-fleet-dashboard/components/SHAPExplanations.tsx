      ...
      <CardContent>
        ...
        <div className="flex items-center justify-center gap-4 mt-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-blue-200">Impact élevé</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3 h-3 rounded bg-amber-500" />
            <span className="text-xs text-blue-200">Impact modéré</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3 h-3 rounded bg-blue-500" />
            <span className="text-xs text-blue-200">Impact faible</span>
          </div>
        </div>
      </CardContent>
    </Card>
