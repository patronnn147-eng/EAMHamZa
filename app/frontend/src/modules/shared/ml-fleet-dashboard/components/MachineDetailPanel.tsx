          ...
          <div className="space-y-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-1">
                  <span className="text-2xl font-black text-white">
                    {Math.round(displayData.rul_days)} <span className="text-sm font-medium text-blue-300">jours restants</span>
                  </span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-slate-800/50 rounded-xl">
                <p className="text-xs text-blue-300 mb-1">Score de Santé</p>
              ...
              <div className="text-center p-4 bg-slate-800/50 rounded-xl">
                <p className="text-xs text-blue-300 mb-1">Fiabilité</p>
              ...
              <div className="text-center p-4 bg-slate-800/50 rounded-xl">
                <p className="text-xs text-blue-300 mb-1">Prob. Défaillance</p>
                <p className={`text-3xl font-black ${displayData.failure_probability > 70 ? 'text-red-600' : 'text-blue-50'}`}>
              ...
              <div className="text-center p-4 bg-slate-800/50 rounded-xl">
                <p className="text-xs text-blue-300 mb-1">Disponibilité</p>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50 border">
                <div className="flex items-center gap-2">
                  <ArrowUpCircle className="h-4 w-4 text-blue-300" />
                  <span className="text-sm font-medium text-blue-200">Priorité (P5)</span>
                </div>
            ...
            {displayData.failure_type_predictions && (
              <div className="p-4 rounded-xl bg-slate-800/50 border">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-bold text-blue-100">Prédictions de Type de Défaillance (P2)</span>
                </div>
                <div className="grid grid-cols-5 gap-2">
                  {Object.entries(displayData.failure_type_predictions).map(([type, prob]) => (
                    <div key={type} className="text-center p-2 bg-slate-800 rounded-lg border">
                      <p className="text-xs font-bold text-blue-200">{type}</p>
                      <p className={`text-lg font-black ${(prob as number) > 0.5 ? 'text-red-600' : 'text-blue-50'}`}>
