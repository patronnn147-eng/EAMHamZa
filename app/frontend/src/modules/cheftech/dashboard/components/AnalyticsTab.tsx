    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="shadow-sm">
          <CardContent className="pt-4 p-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-blue-300 font-bold uppercase">Total Assurances</p>
        ...
        <Card className="shadow-sm">
          <CardContent className="pt-4 p-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-blue-300 font-bold uppercase">Taux de Plannings Actifs</p>
        ...
        <Card className="shadow-sm">
          <CardContent className="pt-4 p-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-blue-300 font-bold uppercase">Durée Moyenne</p>
      ...
      <Card className="border-indigo-100 shadow-md">
        ...
        <CardContent className="pt-6">
          ...
          <div className="grid grid-cols-4 gap-4 mt-3 text-xs text-blue-300 px-1 text-center">
            <div>
        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="h-[250px]">
            {data.trends.length === 0 ? (
              <div className="h-full flex items-center justify-center text-blue-400 text-sm italic">
