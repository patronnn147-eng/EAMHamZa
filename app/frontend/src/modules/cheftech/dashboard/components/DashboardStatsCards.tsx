    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-10 mt-2">
      <Card className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-slate-800 dark:bg-slate-900 group overflow-hidden relative">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Interventions</p>
              <p className="text-3xl font-extrabold text-white dark:text-white">{stats.total_interventions}</p>
              <div className="flex items-center mt-2">
                <span className="flex h-2 w-2 rounded-full bg-blue-500 mr-2 animate-pulse" />
                <p className="text-[11px] font-medium text-blue-300">{stats.interventions_en_cours} en cours</p>
              </div>
            </div>
      ...
      <Card className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-slate-800 dark:bg-slate-900 group overflow-hidden relative">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Ordres de Travail</p>
              <p className="text-3xl font-extrabold text-white dark:text-white">{stats.total_ordres_travail}</p>
              <div className="flex items-center mt-2">
                <span className="flex h-2 w-2 rounded-full bg-emerald-500 mr-2" />
                <p className="text-[11px] font-medium text-blue-300">{stats.ordres_en_attente} en attente</p>
              </div>
            </div>
      ...
      <Card className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-slate-800 dark:bg-slate-900 group overflow-hidden relative">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Techniciens</p>
              <p className="text-3xl font-extrabold text-white dark:text-white">{stats.total_techniciens}</p>
              <div className="flex items-center mt-2">
                <span className="flex h-2 w-2 rounded-full bg-purple-500 mr-2" />
                <p className="text-[11px] font-medium text-blue-300">{stats.techniciens_disponibles} disponibles</p>
              </div>
            </div>
      ...
      <Card className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-slate-800 dark:bg-slate-900 group overflow-hidden relative">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Parc Machines</p>
              <p className="text-3xl font-extrabold text-white dark:text-white">{stats.total_machines}</p>
              <div className="flex items-center mt-2">
                <span className="flex h-2 w-2 rounded-full bg-orange-500 mr-2" />
                <p className="text-[11px] font-medium text-blue-300">{stats.machines_critiques} critiques</p>
              </div>
            </div>
      ...
      <Card className={cn(
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-1">Maintenance Prev.</p>
              <p className={cn(
                "text-3xl font-extrabold",
                overdueMaintenance > 0 ? 'text-red-700 dark:text-red-400' : 'text-white dark:text-white'
              )}>
