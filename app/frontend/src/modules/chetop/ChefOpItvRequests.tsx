    ...
    <div className="p-8 animate-premium-fade-in">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-black text-white dark:text-white tracking-tight">Demandes d'intervention</h1>
            <p className="text-blue-300 font-medium">Gérez vos demandes et suivez leur approbation par l'admin</p>
          </div>
          <Button 
        ...
        <div className="relative group">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-blue-400 group-focus-within:text-gradient-premium transition-colors" />
          <Input
            ...
            <TableBody>
              {(() => {
                ...
                <TableRow key={req.id} className="hover:bg-slate-800/50/50 transition-colors">
                  ...
                  <TableCell className="max-w-xs truncate text-blue-200 font-medium">{req.description}</TableCell>
                  <TableCell className="text-blue-300">{new Date(req.requested_at).toLocaleDateString()}</TableCell>
