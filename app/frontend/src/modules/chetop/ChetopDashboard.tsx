  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-lg animate-pulse font-bold text-gray-400 italic">Chargement du tableau de bord...</div>
      </div>
    );
  }
      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
          <div>
            ...
            <p className="text-gray-500 font-medium text-lg border-l-4 border-violet-500 pl-4 py-1">
