...
async def query_rapportss(
    ...
    logger.debug(f"Querying rapportss: query={query}, sort={sort}, skip={skip}, limit={limit}, fields={fields}")
...
async def delete_rapportss_batch(
    ...
    try:
        ...
        return {"message": f"Successfully deleted {deleted_count} rapportss", "deleted_count": deleted_count}
    except Exception as e:
        await db.rollback()
