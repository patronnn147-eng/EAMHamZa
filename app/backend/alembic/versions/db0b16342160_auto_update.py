...
def upgrade() -> None:
    ...
    sa.Column('type', sa.String(), nullable=False),
    sa.Column('date_derniere_maintenance', sa.DateTime(timezone=True), nullable=True),
    sa.Column('date_prochaine_maintenance', sa.DateTime(timezone=True), nullable=True),
    sa.Column('image_url', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_machines_id'), 'machines', ['id'], unique=False)
    op.create_table('maintenances_planifiees',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_maintenances_planifiees_id'), 'maintenances_planifiees', ['id'], unique=False)
    ...
    op.create_table('ordres_intervention',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_ordres_intervention_id'), 'ordres_intervention', ['id'], unique=False)
    op.create_table('ordres_travail',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_ordres_travail_id'), 'ordres_travail', ['id'], unique=False)
    op.create_table('planning_ordres_travail',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_planning_ordres_travail_id'), 'planning_ordres_travail', ['id'], unique=False)
    op.create_table('planning_utilisateurs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('planning_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_planning_utilisateurs_id'), 'planning_utilisateurs', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_planning_utilisateurs_id'), table_name='planning_utilisateurs')
    op.drop_table('planning_utilisateurs')
    op.drop_index(op.f('ix_planning_ordres_travail_id'), table_name='planning_ordres_travail')
    ...
    op.drop_index(op.f('ix_maintenances_planifiees_id'), table_name='maintenances_planifiees')
