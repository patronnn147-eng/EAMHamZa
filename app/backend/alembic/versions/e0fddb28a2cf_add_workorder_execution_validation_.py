...
def upgrade() -> None:
    ...
    op.add_column('ordres_travail', sa.Column('date_debut', sa.DateTime(timezone=True), nullable=True))
    op.add_column('ordres_travail', sa.Column('date_fin', sa.DateTime(timezone=True), nullable=True))
    op.add_column('ordres_travail', sa.Column('rapport', sa.Text(), nullable=True))
    op.add_column('ordres_travail', sa.Column('failure_type', sa.String(length=100), nullable=True))
