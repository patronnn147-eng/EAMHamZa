...
def upgrade() -> None:
    op.create_index('idx_planning_machines_machine_id', 'planning_machines', ['machine_id'])
    op.create_index('idx_planning_machines_planning_id', 'planning_machines', ['planning_id'])
